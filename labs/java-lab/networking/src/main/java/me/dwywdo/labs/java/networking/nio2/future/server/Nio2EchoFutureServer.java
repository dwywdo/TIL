package me.dwywdo.labs.java.networking.nio2.future.server;
...
public class Nio2EchoFutureServer extends Demo {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
        ...
        while (active) {
            Future<AsynchronousSocketChannel> socketChannelFuture = serverSocketChannel.accept(); // Non-blocking

            AsynchronousSocketChannel socketChannel = socketChannelFuture.get(); // Blocking
